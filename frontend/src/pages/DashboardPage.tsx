...
export function DashboardPage({ themeVariant }: { themeVariant?: 'forest' } = {}) {
  ...
  useEffect(() => {
    ...
    void portfolioService.getValuationHistory(historyPortfolioId, chartSymbol || undefined)
      ...
      .catch(() => setHistory([]))
    void portfolioService.getHoldings(historyPortfolioId).then(setChartHoldings).catch(() => setChartHoldings([]))
  ...
  return (
    <div className="page-stack">
      <header className="hero">
        <div>
          {isForestTheme && <p className="eyebrow">Forest palette preview</p>}
